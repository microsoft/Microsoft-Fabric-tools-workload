...
This document provides comprehensive details about the package structure, JSON format, and creation process used by the PackageInstallerItem. For general information about the PackageInstallerItem, see the [main README](./README.md).
...
The generated package.json follows this structure and is validated against the [JSON Schema](../../../Workload/app/items/PackageInstallerItem/package/package.schema.json):
...
The package.json files can be validated against the comprehensive [JSON Schema](../../../Workload/app/items/PackageInstallerItem/package/package.schema.json) which defines:
...
```json
{
  "$schema": "../../../Workload/app/items/PackageInstallerItem/package/package.schema.json",
  "id": "your-package-id",
  ...
}
```
