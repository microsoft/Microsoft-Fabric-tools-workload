...
import { DocumentAdd24Regular, Code24Regular } from "@fluentui/react-icons";
import "../../styles.scss";

interface VSCodeEditorItemEmptyProps {
  onCreateNewFile: () => void;
  onUploadFile: () => void;
}

export function VSCodeEditorItemEmpty({ onCreateNewFile, onUploadFile }: VSCodeEditorItemEmptyProps) {
  return (
    <div className="itemEditorEmpty">
      ...
      >
        ...
        >
          Start coding by creating a new file or uploading an existing one. 
          Experience VSCode-like editing with syntax highlighting, IntelliSense, and more.
        </Text>
